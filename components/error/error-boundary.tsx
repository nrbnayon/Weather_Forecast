  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="flex flex-col items-center justify-center text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold text-foreground mb-4 text-balance">Something went wrong</h1>

        <p className="text-muted-foreground mb-8 text-pretty leading-relaxed">
          The weather app encountered an unexpected error. Please try refreshing the page or contact support if the
          problem persists.
        </p>

        {process.env.NODE_ENV === "development" && error && (
          <details className="mb-6 p-4 bg-card rounded-lg text-left w-full">
            <summary className="text-card-foreground font-medium cursor-pointer mb-2">Error Details</summary>
