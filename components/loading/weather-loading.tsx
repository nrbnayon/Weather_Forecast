...
export function WeatherLoading({ className }: WeatherLoadingProps) {
  return (
    <div className={cn("space-y-6", className)}>
      ...
      <div className="bg-weather-medium-purple rounded-2xl p-8 relative overflow-hidden">
        <div className="flex items-center justify-center h-32">
          <div className="flex flex-col items-center gap-4">
            <LoadingSpinner size="md" />
            <p className="text-weather-white text-lg font-medium">Loading...</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div className="h-6 w-32 bg-weather-medium-purple rounded mb-4"></div>
